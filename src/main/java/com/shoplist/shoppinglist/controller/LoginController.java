...
import com.shoplist.shoppinglist.service.UserRepr;
import com.shoplist.shoppinglist.service.UserService;
...
public class LoginController {
    ...
    public String registerNewUser(@Valid @ModelAttribute("user") UserRepr userRepr, BindingResult bindingResult) {
        ...
        if (!userRepr.getPassword().equals(userRepr.getRepeatPassword())) {
            bindingResult.rejectValue("password", "", "пароли не совподают");
            return "register";
        }
